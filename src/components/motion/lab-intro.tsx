...
export function LabIntro() {
  ...
  return <AnimatedDialog open={open} onDismiss={close} label="Welcome to Zesky Lab" className="lab-intro">
    ...
    <div className="intro-identity"><span data-dialog-item>ZESKY</span><span data-dialog-item>LAB<span className="intro-star" aria-hidden="true">✳</span></span></div>
    <div className="intro-bottom"><p>Software. Systems. Stories.</p><button className="text-link" onClick={close}>Skip intro ↗</button></div>
  </AnimatedDialog>;
}
