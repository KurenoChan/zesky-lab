...
export function CaptureIllustration() {
  return <div className="capture-art" aria-hidden="true">
    ...
    <span>DMIT / CAPTURE WORKFLOW</span><div className="capture-nodes"><span>Browser</span><i>↔</i><span>Bridge</span><i>↔</i><span>Scanner</span></div><small>System illustration · Not a live scan</small>
  </div>;
}
